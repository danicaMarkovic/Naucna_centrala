...
@Document(indexName = RejectedArticleIndex.INDEX_NAME, type = RejectedArticleIndex.TYPE_NAME, shards = 1, replicas = 0)
public class RejectedArticleIndex {

	public static final String INDEX_NAME = "rejectedarticleindex";
	public static final String TYPE_NAME = "rejectedarticle";
